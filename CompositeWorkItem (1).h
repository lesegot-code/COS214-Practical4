...
class CompositeWorkItem : public WorkItem{
    ...
    public:
        ...
        */
        // >>> AJBA'S CHANGE: added the "override" keyword only. The
        // declaration and CompositeWorkItem.cpp's implementation were
        // already here and already correct - this just formally hooks it
        // into WorkItem's new virtual detach().
